namespace ClothingStore.Models
{
    public class DbInitializer
    {
        ...
        {
            ClothingStoreDbContext context = applicationBuilder.ApplicationServices.CreateScope
                ().ServiceProvider.GetRequiredService<ClothingStoreDbContext>();
            ...
            if(!context.Sneakers.Any())
            {
                ...
                ,
                         Sku = "CT8532-126",
                         IsSneakersofTheWeek = false,
                         Description = "The Air Jordan 3 Retro ‘Cardinal Red’ showcases a distinctive palette influenced by an OG colorway" +
                ...
                ,
                     Sku = "CT8527-700",
                     IsSneakersofTheWeek = false,
                     Description = "Originally released in 2006, the Air Jordan 4 Retro Lightning (2021) is one of the most renowned retro" +
                ...
                ,
                     Sku = "5088-610",
                     IsSneakersofTheWeek = false,
                     Description = "Combining elements of three certified classic AJ1’s, the 2018 Jordan 1 Retro High Bred Toe is like" +
                ...
                ,
                      Sku = "GZ6984",
                      IsSneakersofTheWeek = true,
                      Description = "The adidas Yeezy Boost 700 Sun is primarily composed of a bright yellow mesh, leather, and suede upper with back and" +
                ...
                ,
                       Sku = "GW6373",
                       IsSneakersofTheWeek = false,
                       Description = "Composed of tonal grey mesh, suede, and leather, the adidas Yeezy 500 Granite offers a monochromatic styling" +
                ...
                ,
                         Sku = "DO9395-400",
                         IsSneakersofTheWeek = true,
                         Description = "The Nike SB Dunk Low Los Angeles Dodgers features a white leather upper with blue overlays and red Swoosh logos." +
                ...
                ,
                           Sku = "DD1875-100",
                           IsSneakersofTheWeek = true,
                           Description = "The Nike Vaporwaffle sacai Sail Gum features a Sail nylon upper with light grey suede overlays and tumbled leather" +
                ...
                ,
                            Sku = "HP8739",
                            IsSneakersofTheWeek = false,
                            Description = "The adidas Yeezy Foam RNR Onyx arrives with an Onyx, oval-cut foam construction made of part EVA and algae. At the base, a cushioned footbed offers comfort" +
        ...
        public static Dictionary<string, Category> Categories
        {
            get
            {
                if(categories == null)
                {
                    ...
                    {
                        new Category{CategoryName = "Basketball Shoes"},
                        new Category{CategoryName = "Running Shoes"},
                        new Category{CategoryName = "Lifestyle Shoes"}
                    };
